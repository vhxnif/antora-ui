...
image::/_/img/note-logo.svg[Spring,300,200]
...
[.left]
.Image A
image::/_/img/note-logo.svg[A,240,180]

[.left]
.Image B
image::/_/img/note-logo.svg[B,240,180]
--
...
image::/_/img/note-logo.svg[Spring,640,480]

=== Sizing images (2)

image::/_/img/note-logo.svg[Spring,50%]


=== Taming SVGs

image::/_/img/note-logo.svg[Static,300]

image::/_/img/note-logo.svg[Interactive,300,opts=interactive]

image::/_/img/note-logo.svg[Embedded,300,opts=inline]
